...
function scorm_get_toc($user, $scorm, $cmid, $toclink=TOCJSLINK, $currentorg='', $scoid='', $mode='normal',
    ...
    if ($tocheader) {
    /* JM Cambio la estructura de la lista de contenidos para adaptarla a Bootstrap. Respeto las clases, elimino las clases CSS con estilos antiguos. Restaurar si el comportamiento es extraño.
    ...
    *********************************************************************************/
        $result->toc = html_writer::start_div('yui3-g-r', array('id' => 'scorm_layout'));
        $result->toc .= html_writer::start_div('col-lg-2 col-md-2', array('id' => 'scorm_toc'));
        $result->toc .= html_writer::div('', '', array('id' => 'scorm_toc_title'));
        $result->toc .= html_writer::start_div('', array('id' => 'scorm_tree'));
    }
    ...
    /* JM Reposiciono el botón del menú para incluirlo en la cabecera en player.php
    ...
    ********************************************************************************/
        $result->toc .= html_writer::start_div('', array('id' => 'scorm_content', 'class' => 'col-lg-10 col-md-10 col-sm-12 col-xs-12')); // JM Añado clases Bootstrap
