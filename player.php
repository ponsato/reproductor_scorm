...
/* JM Pinto aquí el botón del menú para que aparezca arriba. Traigo el fragmento de locallib.php línea 1897 */
echo html_writer::start_div('', array('class' => 'navbar navbar-default navbar-scorm','role' => 'navigation','style' => 'background-color:rgba(30,30,30,.0)'));
echo html_writer::start_div('', array('class' => 'col-md-12', 'id' => 'barra_navegacion'));
echo html_writer::start_div('', array('class' => 'navbar-header pull-left','id' => 'scorm_toc_toggle'));
echo html_writer::tag('button', '', array('id' => 'scorm_toc_toggle_btn','class' => 'navbar-toggle boton_indice habilita_toggle','style' => 'display:block')).html_writer::end_div().html_writer::end_div().html_writer::end_div();
/*********************************************************************************************************/
...
echo html_writer::start_div('', array('id' => 'toctree', 'class' => 'container')); // JM añado clase Bootstrap
